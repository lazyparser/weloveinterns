...
openEuler 是国内的又一个 Linux 发行版社区。起初由 华为 发起，中科院软件所是最早一批和可能目前最活跃的社区贡献单位。去年主要是软件所的OS团队在进行贡献。2021年7月开始，PLCT实验室开始与华为的工程师一起负责 RISC-V 平台上的 oE 的构建和维护工作。目前老板已经到位，项目经理已经就绪，测试团队已经组建，CI基础设施订单以下。软硬件环境都已经准备好，就差你来干活了。
