...
矽速科技正在寻找一位懂内容、懂传播、懂用户、也有增长意识的市场运营，和我们一起把产品做成真正有全球影响力的科技品牌。

**岗位职责：**
- 负责公司产品的市场宣发、内容策划与传播包装；
- 负责国内外社媒平台运营，包括 B站、小红书、抖音、YouTube、X 、Reddit等；
- 提炼产品卖点，输出文案、海报、详情页、短内容脚本等传播素材；
- 拓展和维护 KOL / KOC / 科技媒体合作资源，推动测评、开箱、联动传播；
- 跟踪传播效果、用户反馈和数据表现，持续复盘优化；
- 配合新品发布、活动传播、品牌内容建设等相关工作；


**岗位要求：**
- 最好有市场运营、品牌运营、内容运营或相关经验；
- 文案能力强，有选题策划和内容包装能力；
- 熟悉主流社媒平台的内容逻辑和传播玩法；
- 对科技、数码、AI、极客文化有兴趣，能快速理解产品；
- 有执行力和推进能力，能主动把事情往前做；
- 有基本数据分析和复盘能力；

**加分项：**
- 做过科技、消费电子、AI 硬件相关品牌或内容传播；
- 有海外社媒运营经验；
- 有 KOL / KOC / 红人合作经验；
- 有独立站、品牌出海、海外 DTC 相关经验；
- 英文读写能力较好；
...
PicoClaw (https://picoclaw.io/) 是近期人气非常火爆的类 OpenClaw 开源项目，使用 Golang 语言实现，目前正处于火热的开发阶段。随着项目快速扩大，开发者数量和PR、Issues日益增多，仅靠几名员工兼顾微信群、社区公众号和论坛的管理已经无法满足需求。希望以此为契机，招募新同学作为社区经理（Community Manager，CM）完成开源技术社区运营的部分工作，并在这个过程中，逐渐培养出优秀的社区运营经理。这个工作本身需要有一点点计算机技术基础（但是不多），同时具有技术和管理属性，适合对社区运营增长感兴趣的小伙伴参加。

本实习岗位为甲辰计划联合实习岗位，目前根据具体认领的任务，由矽速科技、苦芽科技提供实习合同和实习费。

**工作内容：**

- 参与管理 PicoClaw 社区运营、用户答疑、Issue 回复、活动组织等日常社区运营工作。
- 搜集全世界 AI Agents 的各类新闻和进展，进行整理和汇总。
- 活动组织，包括各类线下活动展示和校园活动。
- 面向英文世界的宣发视频制作等。

**岗位要求：**
- 为人正直；能够放低自己的姿态，谦卑且勇敢；并且能够积极的看待这个世界。（开源社区是一个社会的缩影，内心需要足够强大才能长期面对所有的社会面。）
- 良好的自学能力；主动观测、主动收集、主动沟通、主动反馈。
- 具备良好的倾听能力、理解能力和共情能力；阅读并掌握《非暴力沟通》、《关键冲突》、《关键对话》 等沟通原则或技能。
- LV2 技术能力要求。能看懂 Golang、Bash、Python 等语言。
- 熟练使用 Claude Code、 OpenAI GPT/Codex、 google Gemini/Antigravity 等国内外AI工具。
- 对新技术具有强烈的好奇心，同时对于盲目AI乐观主义抱有辩证分析的能力。
...
- 能力等级 Lv2 及以上。
- 熟悉 TypeScript，具备扎实的前端/Node.js 工程开发能力，不排斥阅读和修改既有代码；  
- 具备良好的代码洁癖，注重命名规范、目录结构合理性及 Git 提交规范，坚持 KISS (Keep It Simple, Stupid) 原则，拒绝过度设计；  
- 有自觉编写测试的习惯，能通过测试用例保障代码边界与核心逻辑的可靠性；  
- 具备技术总结与分享的意愿，能主动把“做完的事情”讲清楚，乐于通过文字、视频或技术交流等形式赋能他人。
...
### BJ45 MLIR 开源开发实习生 aka Buddy Compiler 开发（已满，暂停招聘）
