...
RuyiSDK 是中国科学院软件研究所正在开发的面向 RISC-V 开发人员的工具集，由PLCT实验室负责承建。PLCT实验室看到MoonBit语言的潜力，并计划在2024Q4-2025Q2期间开放不少于100名实习岗位用于探索 MoonBit 语言及其运行时环境的能力边界，并在 RuyiSDK 中集成对 MoonBit 的支持。
