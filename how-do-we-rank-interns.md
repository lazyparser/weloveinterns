...
- 具备很好的培养潜力及可能性，自学能力强。
- 得到比招募实习生的团队负责人更高一级的主管的同意。

加入团队的 LV0，一般要求在2周内完成到LV1的能力提升。否则实习终止。

目前，机器人测试岗位、App测试岗位等接收LV0。

LV1 低能力者
-----------

- 至少掌握一门编程语言，C/C++/Java 必须掌握一门。会基本的 Python/Bash 脚本编程。
- 具备基本 Office 软件操作能力；能够在组内进行技术报告。
...
- 在LV1基础上，对于数据结构、算法导论、计算机组成原理、编译原理、计算机网络、现代操作系统、现代数据库原理等课程有扎实的了解，学习过，能够快速的复习和掌握。。
- 能够熟练使用 Linux 命令行工具，包括 find、grep、sed 等。
...
- 熟练使用一门以上编程语言，一般是 C/C++/Java + Python/Ruby/Bash；
- 熟练使用bash/python脚本语言；
- 熟练阅读英文技术资料。
- 能够熟练的进行公开的技术报告。
